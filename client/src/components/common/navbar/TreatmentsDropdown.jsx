...
function TreatmentsDropdown() {
  ...
  const treatments = [
    ...
    { id: 5, name: "Manicures & Pedicures", path: "/treatments/manicures-pedicures" },
    { id: 6, name: "Eyelash Extensions & Lifts", path: "/treatments/eyelash-extensions" },
  ];
  ...
  return (
    <div id="treatments-dropdown" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className={`dropdown-content ${isOpen ? "open" : ""}`} id="dropdown-content">
          {treatments.map((treatment) => (
            <div
              ...
              onKeyDown={(e) => {
                if (e.key === "Enter" || e.key === " ") navigate(treatment.path);
              }}
